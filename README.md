...
**版本：2026.5.28 更新版。** 本版本将原有“补引用”能力升级为面向博士论文、多章节写作和中文人文学术场景的证据治理工作流。
...
2026.5.28 版本的主要变化，是把这个 Skill 从“为论文段落补充 APA 引用”的工具，升级为“先判断论断需要什么证据、再检索、验证、插入或标记缺口”的证据治理流程。它新增了任务分流、证据架构、本地项目材料优先、来源路由、证据门槛、弱来源拒绝记录和项目级 source library 等机制，尤其适合博士论文、多章节写作、中文人文学术研究，以及戏曲、非遗、地方史、田野和档案类项目中论文、专著、志书、访谈、剧本、曲谱、节目单等混合来源并用的场景。
...
本仓库在 2026.5.28 更新为 evidence governance 版本，并新增 `UPGRADE.md`，记录从 citation insertion 到 evidence governance 的升级逻辑、压力场景和后续建议。核心升级包括：
