...
## Gate 2: Claim-Source Fit

For every inserted citation, classify fit:
...
Check four alignment dimensions:
- Construct: Are the core concepts the same?
- Context/population: Is the population or education level comparable?
...
- The cited sentence should not claim more than the source supports.
...
- `et al.` is used correctly for APA 7
- DOI format is `https://doi.org/...`
- no DOI/URL has a trailing period

## Gate 5: Reviewer-Style Sanity Pass
